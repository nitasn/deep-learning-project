...
In this project, we use the chest-xray-pneumonia dataset on Kaggle to demonstrate several different deep-learning techniques we learned during the course.

\textbf{Task 1.a. Binary Classification}: we train a CNN on a healthy/sick labeled dataset of lungs x-ray images;

\textbf{Task 1.b. Multiclass classification}: we further improve on 1.a. by destinguishing between bacterial/viral infection;
